...
***
#### Parser
Single intance.  Top-most object.
##### Properties
...
***
#### Database
Extrapoliation of the DbSchema `Project` object.  Assumes all schemas are contained within a single database.
##### Properties
...
##### Properties
 ...
 - `isView`: `boolean`: Indiciates whether the table is actually a view.
 - `columns`: `array[Column]`: Array of Column objects contained within the Table.
 - `indicies`: `array[TableIndex]`: Array of Table Index objects contained within te Table.
...
##### Properties
 ...
 - `isPrimary`: `boolean`: Indiciates if the index is the primary key.
